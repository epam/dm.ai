...
public interface InputContextConfig {
    ...
    /**
     * How many levels of linked/child Confluence pages to follow when resolving
     * Confluence URLs from the ticket text. 0 means only pages explicitly linked.
     */
    ...
    /**
     * Whether to download attachments for each fetched Confluence page.
     */
    ...
    /**
     * Whether to include the parent ticket's text fields when scanning for Confluence URLs.
     */
