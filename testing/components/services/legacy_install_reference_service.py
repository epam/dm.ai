...
class LegacyInstallReferenceService:
    ...
    @staticmethod
    def _is_active_install_guidance(path: Path, heading_stack: list[str], line: str) -> bool:
        ...
        in_primary_install_docs = (
            normalized_path.endswith("/README.md")
            or normalized_path.endswith("/SKILL.md")
            or "/references/installation/" in normalized_path
        )
        active_heading = any(
        ...
        return actionable_line or (in_primary_install_docs and active_heading)
