...
DMTools is an enterprise dark-factory orchestrator that integrates with multiple platforms and provides 373+ MCP tools for reusable delivery automation.
...
### Common Commands
```bash
dmtools list                          # List all 373+ MCP tools
...
| | [JavaScript Agents](references/agents/javascript-agents.md) | GraalJS development with 373+ MCP tools |
...
| **MCP Tools** | [MCP Tools Reference](references/mcp-tools/README.md) | Auto-generated list of 373+ tools (20 integrations) |
