...
DMTools is an enterprise dark-factory orchestrator that integrates with multiple platforms and provides 377+ MCP tools for reusable delivery automation.
...
### Common Commands
```bash
dmtools list                          # List all 377+ MCP tools
...
- **GitHub** (77 tools): Pull requests, issues, comments, workflows
- **GitLab** (34 tools): Merge requests, issues, CI/CD pipelines
...
| | [JavaScript Agents](references/agents/javascript-agents.md) | GraalJS development with 377+ MCP tools |
...
| **MCP Tools** | [MCP Tools Reference](references/mcp-tools/README.md) | Auto-generated list of 377+ tools (20 integrations) |
