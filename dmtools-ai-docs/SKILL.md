...
DMTools is an enterprise dark-factory orchestrator that integrates with multiple platforms and provides 369+ MCP tools for reusable delivery automation.
...
### Common Commands
```bash
dmtools list                          # List all 369+ MCP tools
...
- **GitHub** (73 tools): Pull requests, issues, comments, workflows
...
| | [JavaScript Agents](references/agents/javascript-agents.md) | GraalJS development with 369+ MCP tools |
...
| **MCP Tools** | [MCP Tools Reference](references/mcp-tools/README.md) | Auto-generated list of 369+ tools (20 integrations) |
