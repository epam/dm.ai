...
- **ADO** (40 tools): Azure DevOps work items, queries, comments, attachments, pull requests, code review threads
...
| | [Azure DevOps](references/configuration/integrations/ado.md) | PAT setup and 40+ tools |
